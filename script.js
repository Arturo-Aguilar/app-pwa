...
function myFunction3() {
  var input, filter, table, tr, td, i, txtValue,z;
	z=document.getElementById("mySelect3").value;
...
function myFunction4() {
  var input, filter, table, tr, td, i, txtValue,a;
	a=document.getElementById("mySelect4").value;
...
//script del formulario de registro nuevo usuario
...
function showTab(n) {
  ...
  if (n == (x.length - 1)) {
    ...
    document.getElementById("nextBtn").innerHTML = "Siguinte";
  }
...
//script para ventana pop cambio d contraseña
...
//SCRIPT PARA VERIFICAR CONTRASEÑA
